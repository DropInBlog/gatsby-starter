        ...
        return (
            <Flex flexDirection="column" alignItems="center" justify="space-between">
                <Text fontSize={["3xl", "4xl", "5xl"]}
                    ...
                    maxWidth="700px"
                    textAlign="center"
                    style={{ "fontFamily": 'Dosis' }}>Posts by {post.title}</Text>
                <Image src={author.photo} size={["80px", "100px", "115px", "125px"]} rounded="full" mt={6}/>
                <Text fontSize="2xl"
                    fontWeight="600"
                    mt={4}
                    color="#545454" 
                    style={{ "fontFamily": 'Dosis' }}>{author.name} · {post.publishedAt}</Text>
                <Text fontSize="lg"
                    fontWeight="500"
                    mt={4}
                    textAlign="center"
